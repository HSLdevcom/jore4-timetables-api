...
open class GetPassingTimeOrderValidityDataRecord private constructor() : TableRecordImpl<GetPassingTimeOrderValidityDataRecord>(GetPassingTimeOrderValidityData.GET_PASSING_TIME_ORDER_VALIDITY_DATA), Record5<UUID?, UUID?, UUID?, Boolean?, Boolean?> {
