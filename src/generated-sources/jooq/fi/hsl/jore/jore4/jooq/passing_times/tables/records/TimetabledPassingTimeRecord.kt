...
open class TimetabledPassingTimeRecord() : UpdatableRecordImpl<TimetabledPassingTimeRecord>(TimetabledPassingTime.TIMETABLED_PASSING_TIME), Record6<UUID?, UUID?, UUID?, YearToSecond?, YearToSecond?, YearToSecond?> {
    ...
    open var passingTime: YearToSecond?
    ...
    override fun valuesRow(): Row6<UUID?, UUID?, UUID?, YearToSecond?, YearToSecond?, YearToSecond?> = super.valuesRow() as Row6<UUID?, UUID?, UUID?, YearToSecond?, YearToSecond?, YearToSecond?>
    ...
    override fun field6(): Field<YearToSecond?> = TimetabledPassingTime.TIMETABLED_PASSING_TIME.PASSING_TIME
    ...
    override fun component6(): YearToSecond? = passingTime
    ...
    override fun value6(): YearToSecond? = passingTime
    ...
    override fun value6(value: YearToSecond?): TimetabledPassingTimeRecord {
        set(5, value)
        return this
    }

    override fun values(value1: UUID?, value2: UUID?, value3: UUID?, value4: YearToSecond?, value5: YearToSecond?, value6: YearToSecond?): TimetabledPassingTimeRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(timetabledPassingTimeId: UUID? = null, vehicleJourneyId: UUID? = null, scheduledStopPointInJourneyPatternRefId: UUID? = null, arrivalTime: YearToSecond? = null, departureTime: YearToSecond? = null, passingTime: YearToSecond? = null): this() {
