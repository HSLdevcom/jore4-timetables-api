...
open class Block(
    ...
    path: ForeignKey<out Record, BlockRecord>?,
    ...
    private constructor(alias: Name, aliased: Table<BlockRecord>?): this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<BlockRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, aliased, parameters)
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, BlockRecord>): this(Internal.createPathAlias(child, key), child, key, BLOCK, null)
     ...
     */
    fun <U> mapping(from: (UUID?, UUID?, YearToSecond?, YearToSecond?, UUID?) -> U): SelectField<U> = convertFrom(Records.mapping(from))

    /**
     * Convenience mapping calling {@link SelectField#convertFrom(Class,
     * Function)}.
     */
    fun <U> mapping(toType: Class<U>, from: (UUID?, UUID?, YearToSecond?, YearToSecond?, UUID?) -> U): SelectField<U> = convertFrom(toType, Records.mapping(from))
}
