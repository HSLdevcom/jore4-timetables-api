...
open class GetPassingTimeOrderValidityData(
    ...
    companion object {
        ...
        /**
         * The reference instance of <code>passing_times.get_passing_time_order_validity_data</code>
         */
        val GET_PASSING_TIME_ORDER_VALIDITY_DATA = GetPassingTimeOrderValidityData()
    }
    ...
    /**
     * The column <code>passing_times.get_passing_time_order_validity_data.vehicle_journey_id</code>.
     */
    val VEHICLE_JOURNEY_ID: TableField<Record, UUID?> = createField(DSL.name("vehicle_journey_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>passing_times.get_passing_time_order_validity_data.first_passing_time_id</code>.
     */
    val FIRST_PASSING_TIME_ID: TableField<Record, UUID?> = createField(DSL.name("first_passing_time_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>passing_times.get_passing_time_order_validity_data.last_passing_time_id</code>.
     */
    val LAST_PASSING_TIME_ID: TableField<Record, UUID?> = createField(DSL.name("last_passing_time_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>passing_times.get_passing_time_order_validity_data.stop_order_is_valid</code>.
     */
    val STOP_ORDER_IS_VALID: TableField<Record, Boolean?> = createField(DSL.name("stop_order_is_valid"), SQLDataType.BOOLEAN, this, "")

    /**
     * The column <code>passing_times.get_passing_time_order_validity_data.coherent_journey_pattern_refs</code>.
     */
    ...
    /**
     * Create an aliased <code>passing_times.get_passing_time_order_validity_data</code> table reference
     */
    ...
    /**
     * Create a <code>passing_times.get_passing_time_order_validity_data</code> table reference
     */
