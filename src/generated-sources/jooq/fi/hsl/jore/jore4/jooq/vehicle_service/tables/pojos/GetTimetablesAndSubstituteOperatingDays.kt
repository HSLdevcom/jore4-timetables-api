...
data class GetTimetablesAndSubstituteOperatingDays(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: GetTimetablesAndSubstituteOperatingDays = other as GetTimetablesAndSubstituteOperatingDays
    ...
    override fun toString(): String {
        val sb = StringBuilder("GetTimetablesAndSubstituteOperatingDays (")
