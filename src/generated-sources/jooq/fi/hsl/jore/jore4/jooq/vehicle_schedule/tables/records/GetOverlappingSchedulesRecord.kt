...
open class GetOverlappingSchedulesRecord private constructor() : TableRecordImpl<GetOverlappingSchedulesRecord>(GetOverlappingSchedules.GET_OVERLAPPING_SCHEDULES), Record8<UUID?, UUID?, UUID?, Int?, Int?, Any?, Any?, Any?> {
