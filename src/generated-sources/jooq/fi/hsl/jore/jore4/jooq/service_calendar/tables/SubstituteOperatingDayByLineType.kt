...
open class SubstituteOperatingDayByLineType(
     ...
     */
    val SUBSTITUTE_OPERATING_DAY_BY_LINE_TYPE_ID: TableField<Record, UUID?> = createField(DSL.name("substitute_operating_day_by_line_type_id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this, "")
     ...
     */
    val TIMEZONE: TableField<Record, String?> = createField(DSL.name("timezone"), SQLDataType.CLOB.nullable(false).defaultValue(DSL.field(DSL.raw("internal_utils.const_default_timezone()"), SQLDataType.CLOB)), this, "")
