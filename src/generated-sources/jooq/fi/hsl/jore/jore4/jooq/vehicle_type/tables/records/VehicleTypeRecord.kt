...
open class VehicleTypeRecord() : UpdatableRecordImpl<VehicleTypeRecord>(VehicleType.VEHICLE_TYPE_), Record4<UUID?, String?, JSONB?, Short?> {
     ...
     */
    constructor(vehicleTypeId: UUID? = null, label: String? = null, descriptionI18n: JSONB? = null, hslId: Short? = null): this() {
