...
open class BlockRecord() : UpdatableRecordImpl<BlockRecord>(Block.BLOCK), Record5<UUID?, UUID?, YearToSecond?, YearToSecond?, UUID?> {
     ...
     */
    constructor(blockId: UUID? = null, vehicleServiceId: UUID? = null, preparingTime: YearToSecond? = null, finishingTime: YearToSecond? = null, vehicleTypeId: UUID? = null): this() {
