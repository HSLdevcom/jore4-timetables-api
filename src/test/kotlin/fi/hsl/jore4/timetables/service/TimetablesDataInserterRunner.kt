...
class TimetablesDataInserterRunner(
    val dataInerterDatabaseConfiguration: DataInserterDatabaseProperties,
    ...
    private fun buildDatabaseArguments(): String {
        ...
        return listOf(
            ...
            "--user ${dataInerterDatabaseConfiguration.username}",
            "--password ${dataInerterDatabaseConfiguration.password}"
        ).joinToString(" ")
    }
}
