...
import fi.hsl.jore4.timetables.config.TestDatabaseProperties
...
class TimetablesDataInserterRunner(
    val testDatabaseConfiguration: TestDatabaseProperties,
    ...
    private fun buildDatabaseArguments(): String {
        ...
        return listOf(
            ...
            "--user ${testDatabaseConfiguration.username}",
            "--password ${testDatabaseConfiguration.password}"
        ).joinToString(" ")
    }
}
