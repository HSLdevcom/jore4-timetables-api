...
@IntTest
class ReplaceTimetablesServiceTest
    @Autowired
    constructor(
        ...
        inner class ReplaceTimetables {
            ...
            inner class WithMultipleStagingFrames {
                        ...
                        TimetablesDataset.createFromMutableMap(
                            mutableMapOf(
                                "_vehicle_schedule_frames" to
                                    mutableMapOf(
                                        "current1" to
                                            baseCurrent.deepClone().setFrameProperties(
                                                mutableMapOf(
                ...
                private fun MutableMap<String, Any?>.setFrameProperties(patch: MutableMap<String, Any?>): MutableMap<String, Any?> {
                    this.putAll(patch)
                    return this
                }
        ...
        inner class FetchVehicleScheduleFramesToReplace {
            ...
            private fun insertDatasetAndFetchFrameIdsToReplace(
                targetPriority: TimetablesPriority = TimetablesPriority.STANDARD
            ): List<UUID> {
                timetablesDataInserterRunner.truncateAndInsertDataset(testData.toJSONString())
