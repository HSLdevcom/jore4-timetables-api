...
open class JsonbPathQueryFirst : AbstractRoutine<JSONB>("jsonb_path_query_first", PgCatalog.PG_CATALOG, SQLDataType.JSONB) {
    companion object {
        ...
        val PATH: Parameter<Any?> = Internal.createParameter("path", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"jsonpath\""), false, false)

        /**
         * The parameter <code>pg_catalog.jsonb_path_query_first.vars</code>.
         */
        val VARS: Parameter<JSONB?> = Internal.createParameter("vars", SQLDataType.JSONB, false, false)

        /**
         * The parameter <code>pg_catalog.jsonb_path_query_first.silent</code>.
         */
        val SILENT: Parameter<Boolean?> = Internal.createParameter("silent", SQLDataType.BOOLEAN, false, false)
    }
     ...
     */
    fun setTarget(value: JSONB?): Unit = setValue(TARGET, value)
     ...
     */
    fun setPath(value: Any?): Unit = setValue(PATH, value)
     ...
     */
    fun setVars(value: JSONB?): Unit = setValue(VARS, value)
     ...
     */
    fun setSilent(value: Boolean?): Unit = setValue(SILENT, value)
