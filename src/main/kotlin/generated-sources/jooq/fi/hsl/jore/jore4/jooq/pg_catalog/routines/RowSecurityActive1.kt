...
open class RowSecurityActive1 : AbstractRoutine<Boolean>("row_security_active", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.row_security_active.RETURN_VALUE</code>.
         */
