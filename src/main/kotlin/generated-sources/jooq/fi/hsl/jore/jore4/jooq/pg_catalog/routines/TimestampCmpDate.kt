...
open class TimestampCmpDate : AbstractRoutine<Int>("timestamp_cmp_date", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.timestamp_cmp_date.RETURN_VALUE</code>.
         */
