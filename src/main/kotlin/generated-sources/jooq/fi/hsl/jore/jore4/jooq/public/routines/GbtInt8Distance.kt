...
open class GbtInt8Distance : AbstractRoutine<Double>("gbt_int8_distance", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter <code>public.gbt_int8_distance.RETURN_VALUE</code>.
         */
