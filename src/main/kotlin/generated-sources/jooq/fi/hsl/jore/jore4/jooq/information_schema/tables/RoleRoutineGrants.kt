...
open class RoleRoutineGrants(
    ...
    override fun `as`(alias: Table<*>): RoleRoutineGrants = RoleRoutineGrants(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): RoleRoutineGrants = RoleRoutineGrants(name.getQualifiedName(), null)
}
