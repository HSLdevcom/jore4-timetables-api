...
open class GbtInt2Distance : AbstractRoutine<Double>("gbt_int2_distance", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter <code>public.gbt_int2_distance.RETURN_VALUE</code>.
         */
