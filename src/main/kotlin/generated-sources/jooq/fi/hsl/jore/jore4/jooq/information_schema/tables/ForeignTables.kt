...
open class ForeignTables(
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, FOREIGN_TABLES, null)
    ...
    override fun `as`(alias: Table<*>): ForeignTables = ForeignTables(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ForeignTables = ForeignTables(name.getQualifiedName(), null)
}
