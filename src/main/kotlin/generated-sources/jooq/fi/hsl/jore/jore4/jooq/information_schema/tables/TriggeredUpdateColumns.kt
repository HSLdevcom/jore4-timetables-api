...
open class TriggeredUpdateColumns(
    ...
    override fun `as`(alias: Table<*>): TriggeredUpdateColumns = TriggeredUpdateColumns(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): TriggeredUpdateColumns = TriggeredUpdateColumns(name.getQualifiedName(), null)
}
