...
open class InformationSchemaCatalogName(
    ...
    override fun `as`(alias: Table<*>): InformationSchemaCatalogName = InformationSchemaCatalogName(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): InformationSchemaCatalogName = InformationSchemaCatalogName(name.getQualifiedName(), null)
}
