...
open class GbtMacad8Consistent : AbstractRoutine<Boolean>("gbt_macad8_consistent", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter <code>public.gbt_macad8_consistent.RETURN_VALUE</code>.
         */
        ...
        /**
         * The parameter <code>public.gbt_macad8_consistent._3</code>.
         */
        val _3: Parameter<Short?> = Internal.createParameter("_3", SQLDataType.SMALLINT, false, true)

        /**
         * The parameter <code>public.gbt_macad8_consistent._4</code>.
         */
