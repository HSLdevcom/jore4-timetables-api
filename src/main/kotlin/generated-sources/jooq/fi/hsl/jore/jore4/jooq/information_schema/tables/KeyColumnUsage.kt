...
open class KeyColumnUsage(
     ...
     */
    val POSITION_IN_UNIQUE_CONSTRAINT: TableField<Record, Int?> = createField(DSL.name("position_in_unique_constraint"), SQLDataType.INTEGER, this, "")
    ...
    override fun `as`(alias: Table<*>): KeyColumnUsage = KeyColumnUsage(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): KeyColumnUsage = KeyColumnUsage(name.getQualifiedName(), null)
}
