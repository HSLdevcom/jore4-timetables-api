...
open class TimestamptzCmpDate : AbstractRoutine<Int>("timestamptz_cmp_date", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.timestamptz_cmp_date.RETURN_VALUE</code>.
         */
