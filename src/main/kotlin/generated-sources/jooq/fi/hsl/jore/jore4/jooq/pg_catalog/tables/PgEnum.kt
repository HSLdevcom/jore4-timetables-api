...
open class PgEnum(
     ...
     */
    val ENUMTYPID: TableField<Record, Long?> = createField(DSL.name("enumtypid"), SQLDataType.BIGINT.nullable(false), this, "")

    /**
     * The column <code>pg_catalog.pg_enum.enumsortorder</code>.
     */
    val ENUMSORTORDER: TableField<Record, Float?> = createField(DSL.name("enumsortorder"), SQLDataType.REAL.nullable(false), this, "")

    /**
     * The column <code>pg_catalog.pg_enum.enumlabel</code>.
     */
    val ENUMLABEL: TableField<Record, String?> = createField(DSL.name("enumlabel"), SQLDataType.VARCHAR.nullable(false), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, PG_ENUM, null)
