...
open class ForeignServerOptions(
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, FOREIGN_SERVER_OPTIONS, null)
    ...
    override fun `as`(alias: Table<*>): ForeignServerOptions = ForeignServerOptions(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ForeignServerOptions = ForeignServerOptions(name.getQualifiedName(), null)
}
