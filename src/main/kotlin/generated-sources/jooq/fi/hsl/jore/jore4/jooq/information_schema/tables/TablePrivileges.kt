...
open class TablePrivileges(
    ...
    override fun `as`(alias: Table<*>): TablePrivileges = TablePrivileges(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): TablePrivileges = TablePrivileges(name.getQualifiedName(), null)
}
