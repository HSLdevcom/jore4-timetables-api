...
open class PgLastXactReplayTimestamp : AbstractRoutine<OffsetDateTime>("pg_last_xact_replay_timestamp", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    companion object {
