...
open class ApplicableRoles(
    ...
    override fun `as`(alias: Table<*>): ApplicableRoles = ApplicableRoles(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ApplicableRoles = ApplicableRoles(name.getQualifiedName(), null)
}
