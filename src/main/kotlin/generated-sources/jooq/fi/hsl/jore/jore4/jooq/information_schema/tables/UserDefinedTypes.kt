...
open class UserDefinedTypes(
    ...
    override fun `as`(alias: Table<*>): UserDefinedTypes = UserDefinedTypes(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): UserDefinedTypes = UserDefinedTypes(name.getQualifiedName(), null)
}
