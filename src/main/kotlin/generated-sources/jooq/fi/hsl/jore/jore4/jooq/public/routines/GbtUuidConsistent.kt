...
open class GbtUuidConsistent : AbstractRoutine<Boolean>("gbt_uuid_consistent", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter <code>public.gbt_uuid_consistent.RETURN_VALUE</code>.
         */
        ...
        /**
         * The parameter <code>public.gbt_uuid_consistent._2</code>.
         */
        val _2: Parameter<UUID?> = Internal.createParameter("_2", SQLDataType.UUID, false, true)

        /**
         * The parameter <code>public.gbt_uuid_consistent._3</code>.
         */
        val _3: Parameter<Short?> = Internal.createParameter("_3", SQLDataType.SMALLINT, false, true)

        /**
         * The parameter <code>public.gbt_uuid_consistent._4</code>.
         */
     ...
     */
    fun set__2(value: UUID?): Unit = setValue(_2, value)
