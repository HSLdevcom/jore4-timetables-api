...
open class TimestamptzGtDate : AbstractRoutine<Boolean>("timestamptz_gt_date", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.timestamptz_gt_date.RETURN_VALUE</code>.
         */
