...
open class Hashvarlenaextended : AbstractRoutine<Long>("hashvarlenaextended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.hashvarlenaextended.RETURN_VALUE</code>.
         */
