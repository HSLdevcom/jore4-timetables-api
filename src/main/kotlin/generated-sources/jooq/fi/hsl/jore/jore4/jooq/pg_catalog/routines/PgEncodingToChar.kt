...
open class PgEncodingToChar : AbstractRoutine<String>("pg_encoding_to_char", PgCatalog.PG_CATALOG, SQLDataType.VARCHAR) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_encoding_to_char.RETURN_VALUE</code>.
         */
