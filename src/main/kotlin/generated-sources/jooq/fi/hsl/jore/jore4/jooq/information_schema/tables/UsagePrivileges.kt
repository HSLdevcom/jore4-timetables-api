...
open class UsagePrivileges(
    ...
    override fun `as`(alias: Table<*>): UsagePrivileges = UsagePrivileges(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): UsagePrivileges = UsagePrivileges(name.getQualifiedName(), null)
}
