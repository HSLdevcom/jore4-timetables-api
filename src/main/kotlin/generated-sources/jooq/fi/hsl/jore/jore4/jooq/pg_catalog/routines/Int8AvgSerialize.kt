...
open class Int8AvgSerialize : AbstractRoutine<ByteArray>("int8_avg_serialize", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.int8_avg_serialize.RETURN_VALUE</code>.
         */
