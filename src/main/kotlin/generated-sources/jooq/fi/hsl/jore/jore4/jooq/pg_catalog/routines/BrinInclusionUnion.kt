...
open class BrinInclusionUnion : AbstractRoutine<Boolean>("brin_inclusion_union", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.brin_inclusion_union.RETURN_VALUE</code>.
         */
