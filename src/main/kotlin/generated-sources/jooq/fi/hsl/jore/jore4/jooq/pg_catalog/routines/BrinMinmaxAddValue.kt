...
open class BrinMinmaxAddValue : AbstractRoutine<Boolean>("brin_minmax_add_value", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.brin_minmax_add_value.RETURN_VALUE</code>.
         */
