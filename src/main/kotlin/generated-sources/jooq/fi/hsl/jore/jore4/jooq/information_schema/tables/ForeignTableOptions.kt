...
open class ForeignTableOptions(
    ...
    override fun `as`(alias: Table<*>): ForeignTableOptions = ForeignTableOptions(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ForeignTableOptions = ForeignTableOptions(name.getQualifiedName(), null)
}
