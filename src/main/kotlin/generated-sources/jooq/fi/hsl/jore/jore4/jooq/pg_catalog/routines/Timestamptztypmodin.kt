...
open class Timestamptztypmodin : AbstractRoutine<Int>("timestamptztypmodin", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.timestamptztypmodin.RETURN_VALUE</code>.
         */
