...
open class GistBoxConsistent : AbstractRoutine<Boolean>("gist_box_consistent", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.gist_box_consistent.RETURN_VALUE</code>.
         */
