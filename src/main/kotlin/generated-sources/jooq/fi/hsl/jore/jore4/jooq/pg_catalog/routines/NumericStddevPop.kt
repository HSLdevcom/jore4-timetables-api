...
open class NumericStddevPop : AbstractRoutine<BigDecimal>("numeric_stddev_pop", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.numeric_stddev_pop.RETURN_VALUE</code>.
         */
