...
open class BrinSummarizeRange : AbstractRoutine<Int>("brin_summarize_range", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.brin_summarize_range.RETURN_VALUE</code>.
         */
