...
open class XmlIsWellFormed : AbstractRoutine<Boolean>("xml_is_well_formed", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.xml_is_well_formed.RETURN_VALUE</code>.
         */
