...
open class Hashfloat4extended : AbstractRoutine<Long>("hashfloat4extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.hashfloat4extended.RETURN_VALUE</code>.
         */
