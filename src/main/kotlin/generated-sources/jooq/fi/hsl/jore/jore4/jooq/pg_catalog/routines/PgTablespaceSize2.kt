...
open class PgTablespaceSize2 : AbstractRoutine<Long>("pg_tablespace_size", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_tablespace_size.RETURN_VALUE</code>.
         */
