...
open class ConstraintColumnUsage(
    ...
    override fun `as`(alias: Table<*>): ConstraintColumnUsage = ConstraintColumnUsage(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ConstraintColumnUsage = ConstraintColumnUsage(name.getQualifiedName(), null)
}
