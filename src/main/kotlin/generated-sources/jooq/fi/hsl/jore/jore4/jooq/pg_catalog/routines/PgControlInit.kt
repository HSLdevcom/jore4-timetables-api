...
open class PgControlInit : AbstractRoutine<java.lang.Void>("pg_control_init", PgCatalog.PG_CATALOG) {
    companion object {
        ...
        /**
         * The parameter
         * <code>pg_catalog.pg_control_init.float4_pass_by_value</code>.
         */
        val FLOAT4_PASS_BY_VALUE: Parameter<Boolean?> = Internal.createParameter("float4_pass_by_value", SQLDataType.BOOLEAN, false, false)
    ...
    /**
     * Get the <code>float4_pass_by_value</code> parameter OUT value from the
     * routine
     */
    fun getFloat4PassByValue(): Boolean? = get(FLOAT4_PASS_BY_VALUE)
