...
open class StatementTimestamp : AbstractRoutine<OffsetDateTime>("statement_timestamp", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.statement_timestamp.RETURN_VALUE</code>.
         */
