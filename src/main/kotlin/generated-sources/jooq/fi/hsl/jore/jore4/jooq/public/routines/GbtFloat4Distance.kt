...
open class GbtFloat4Distance : AbstractRoutine<Double>("gbt_float4_distance", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter <code>public.gbt_float4_distance.RETURN_VALUE</code>.
         */
