...
open class DateCmpTimestamptz : AbstractRoutine<Int>("date_cmp_timestamptz", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.date_cmp_timestamptz.RETURN_VALUE</code>.
         */
