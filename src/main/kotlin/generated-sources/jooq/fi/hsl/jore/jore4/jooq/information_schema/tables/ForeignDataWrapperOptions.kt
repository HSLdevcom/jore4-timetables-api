...
open class ForeignDataWrapperOptions(
    ...
    override fun `as`(alias: Table<*>): ForeignDataWrapperOptions = ForeignDataWrapperOptions(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ForeignDataWrapperOptions = ForeignDataWrapperOptions(name.getQualifiedName(), null)
}
