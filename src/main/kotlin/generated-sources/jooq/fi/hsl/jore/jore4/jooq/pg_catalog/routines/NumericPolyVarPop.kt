...
open class NumericPolyVarPop : AbstractRoutine<BigDecimal>("numeric_poly_var_pop", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.numeric_poly_var_pop.RETURN_VALUE</code>.
         */
