...
open class Float8RegrIntercept : AbstractRoutine<Double>("float8_regr_intercept", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.float8_regr_intercept.RETURN_VALUE</code>.
         */
