...
open class RoleColumnGrants(
    ...
    override fun `as`(alias: Table<*>): RoleColumnGrants = RoleColumnGrants(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): RoleColumnGrants = RoleColumnGrants(name.getQualifiedName(), null)
}
