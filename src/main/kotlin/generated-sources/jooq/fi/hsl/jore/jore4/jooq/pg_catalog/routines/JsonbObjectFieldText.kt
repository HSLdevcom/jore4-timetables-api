...
open class JsonbObjectFieldText : AbstractRoutine<String>("jsonb_object_field_text", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    companion object {
        ...
        /**
         * The parameter
         * <code>pg_catalog.jsonb_object_field_text.from_json</code>.
         */
        val FROM_JSON: Parameter<JSONB?> = Internal.createParameter("from_json", SQLDataType.JSONB, false, false)

        /**
         * The parameter
         * <code>pg_catalog.jsonb_object_field_text.field_name</code>.
         */
     ...
     */
    fun setFieldName(value: String?): Unit = setValue(FIELD_NAME, value)
