...
open class ColumnUdtUsage(
    ...
    override fun `as`(alias: Table<*>): ColumnUdtUsage = ColumnUdtUsage(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ColumnUdtUsage = ColumnUdtUsage(name.getQualifiedName(), null)
}
