...
open class RoleUdtGrants(
    ...
    override fun `as`(alias: Table<*>): RoleUdtGrants = RoleUdtGrants(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): RoleUdtGrants = RoleUdtGrants(name.getQualifiedName(), null)
}
