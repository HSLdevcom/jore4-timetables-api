...
open class RegexpSplitToArray1 : AbstractRoutine<Array<String?>>("regexp_split_to_array", PgCatalog.PG_CATALOG, SQLDataType.CLOB.getArrayDataType()) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.regexp_split_to_array.RETURN_VALUE</code>.
         */
