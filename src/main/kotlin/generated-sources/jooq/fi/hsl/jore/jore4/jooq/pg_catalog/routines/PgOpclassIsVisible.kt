...
open class PgOpclassIsVisible : AbstractRoutine<Boolean>("pg_opclass_is_visible", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_opclass_is_visible.RETURN_VALUE</code>.
         */
