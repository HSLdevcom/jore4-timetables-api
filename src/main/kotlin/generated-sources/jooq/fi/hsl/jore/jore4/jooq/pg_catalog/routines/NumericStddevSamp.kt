...
open class NumericStddevSamp : AbstractRoutine<BigDecimal>("numeric_stddev_samp", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.numeric_stddev_samp.RETURN_VALUE</code>.
         */
