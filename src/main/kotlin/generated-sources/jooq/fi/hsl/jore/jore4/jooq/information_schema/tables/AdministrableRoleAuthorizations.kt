...
open class AdministrableRoleAuthorizations(
    ...
    override fun `as`(alias: Table<*>): AdministrableRoleAuthorizations = AdministrableRoleAuthorizations(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): AdministrableRoleAuthorizations = AdministrableRoleAuthorizations(name.getQualifiedName(), null)
}
