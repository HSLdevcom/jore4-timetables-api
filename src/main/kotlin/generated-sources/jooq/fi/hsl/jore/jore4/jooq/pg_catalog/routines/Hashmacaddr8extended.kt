...
open class Hashmacaddr8extended : AbstractRoutine<Long>("hashmacaddr8extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.hashmacaddr8extended.RETURN_VALUE</code>.
         */
