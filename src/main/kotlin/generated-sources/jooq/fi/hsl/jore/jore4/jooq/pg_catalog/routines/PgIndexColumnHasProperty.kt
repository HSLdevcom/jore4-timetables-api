...
open class PgIndexColumnHasProperty : AbstractRoutine<Boolean>("pg_index_column_has_property", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {
        ...
        val _1: Parameter<Any?> = Internal.createParameter("_1", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regclass\""), false, true)

        /**
         * The parameter
         * <code>pg_catalog.pg_index_column_has_property._2</code>.
         */
        val _2: Parameter<Int?> = Internal.createParameter("_2", SQLDataType.INTEGER, false, true)

        /**
         * The parameter
         * <code>pg_catalog.pg_index_column_has_property._3</code>.
         */
