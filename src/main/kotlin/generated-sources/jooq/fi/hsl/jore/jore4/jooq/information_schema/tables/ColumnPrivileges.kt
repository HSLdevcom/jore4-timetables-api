...
open class ColumnPrivileges(
    ...
    override fun `as`(alias: Table<*>): ColumnPrivileges = ColumnPrivileges(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ColumnPrivileges = ColumnPrivileges(name.getQualifiedName(), null)
}
