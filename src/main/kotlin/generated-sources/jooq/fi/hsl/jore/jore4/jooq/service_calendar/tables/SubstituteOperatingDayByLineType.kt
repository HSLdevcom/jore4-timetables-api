 ...
 * that public transit does not occur on certain date. Substitute operating 
 * days are always bound to a type of line.
 */
...
open class SubstituteOperatingDayByLineType(
    ...
    companion object {
        ...
        /**
         * The reference instance of <code>service_calendar.substitute_operating_day_by_line_type</code>
         */
        val SUBSTITUTE_OPERATING_DAY_BY_LINE_TYPE = SubstituteOperatingDayByLineType()
    }
    ...
    /**
     * The column <code>service_calendar.substitute_operating_day_by_line_type.substitute_operating_day_by_line_type_id</code>.
     */
    ...
    /**
     * The column <code>service_calendar.substitute_operating_day_by_line_type.type_of_line</code>. The type of line this substitute operating day is bound to.
     */
    ...
    /**
     * The column <code>service_calendar.substitute_operating_day_by_line_type.superseded_date</code>. The date of operating day being superseded.
     */
    ...
    /**
     * The column <code>service_calendar.substitute_operating_day_by_line_type.substitute_day_of_week</code>. The ISO day of week (1=Monday, ... , 7=Sunday) of the day type used as the basis for operating day substitution. A NULL value indicates that there is no public transit at all, i.e. no vehicle journeys are operated within the given time period.
     */
    ...
    /**
     * The column <code>service_calendar.substitute_operating_day_by_line_type.begin_datetime</code>. Calculated timestamp for the instant from which the substituting public transit comes into effect.
     */
    ...
    /**
     * The column <code>service_calendar.substitute_operating_day_by_line_type.end_datetime</code>. Calculated timestamp for the instant (exclusive) until which the substituting public transit is in effect.
     */
    ...
    /**
     * The column <code>service_calendar.substitute_operating_day_by_line_type.substitute_operating_period_id</code>. The id of the substitute operating period
     */
    ...
    /**
     * The column <code>service_calendar.substitute_operating_day_by_line_type.created_at</code>.
     */
    ...
    /**
     * Create an aliased <code>service_calendar.substitute_operating_day_by_line_type</code> table reference
     */
    ...
    /**
     * Create a <code>service_calendar.substitute_operating_day_by_line_type</code> table reference
     */
