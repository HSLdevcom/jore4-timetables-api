...
open class PgLogicalSlotPeekChanges(
    alias: Name,
    ...
    companion object {
         ...
         */
        val PG_LOGICAL_SLOT_PEEK_CHANGES: PgLogicalSlotPeekChanges = PgLogicalSlotPeekChanges()
    }
     ...
     * reference
     */
    constructor(): this(DSL.name("pg_logical_slot_peek_changes"), null)
    override fun getSchema(): Schema? = if (aliased()) null else PgCatalog.PG_CATALOG
    override fun `as`(alias: String): PgLogicalSlotPeekChanges = PgLogicalSlotPeekChanges(DSL.name(alias), this, parameters)
    override fun `as`(alias: Name): PgLogicalSlotPeekChanges = PgLogicalSlotPeekChanges(alias, this, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: String): PgLogicalSlotPeekChanges = PgLogicalSlotPeekChanges(DSL.name(name), null, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: Name): PgLogicalSlotPeekChanges = PgLogicalSlotPeekChanges(name, null, parameters)
    ...
    ): PgLogicalSlotPeekChanges = PgLogicalSlotPeekChanges(DSL.name("pg_logical_slot_peek_changes"), null, arrayOf(
