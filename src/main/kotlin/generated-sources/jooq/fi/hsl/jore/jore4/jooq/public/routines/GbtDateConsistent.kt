...
open class GbtDateConsistent : AbstractRoutine<Boolean>("gbt_date_consistent", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter <code>public.gbt_date_consistent.RETURN_VALUE</code>.
         */
