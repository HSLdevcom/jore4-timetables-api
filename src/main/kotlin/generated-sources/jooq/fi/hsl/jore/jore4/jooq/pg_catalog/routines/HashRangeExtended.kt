...
open class HashRangeExtended : AbstractRoutine<Long>("hash_range_extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.hash_range_extended.RETURN_VALUE</code>.
         */
