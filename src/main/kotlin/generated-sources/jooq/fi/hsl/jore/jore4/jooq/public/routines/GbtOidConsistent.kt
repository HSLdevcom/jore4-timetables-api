...
open class GbtOidConsistent : AbstractRoutine<Boolean>("gbt_oid_consistent", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter <code>public.gbt_oid_consistent.RETURN_VALUE</code>.
         */
