...
open class BtbpcharPatternCmp : AbstractRoutine<Int>("btbpchar_pattern_cmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.btbpchar_pattern_cmp.RETURN_VALUE</code>.
         */
