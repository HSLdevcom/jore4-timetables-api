...
open class RangeContainsElem : AbstractRoutine<Boolean>("range_contains_elem", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.range_contains_elem.RETURN_VALUE</code>.
         */
