...
open class GistPolyDistance : AbstractRoutine<Double>("gist_poly_distance", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.gist_poly_distance.RETURN_VALUE</code>.
         */
