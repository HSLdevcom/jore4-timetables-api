...
open class PgPublicationRel(
     ...
     */
    val PRPUBID: TableField<Record, Long?> = createField(DSL.name("prpubid"), SQLDataType.BIGINT.nullable(false), this, "")

    /**
     * The column <code>pg_catalog.pg_publication_rel.prrelid</code>.
     */
    val PRRELID: TableField<Record, Long?> = createField(DSL.name("prrelid"), SQLDataType.BIGINT.nullable(false), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, PG_PUBLICATION_REL, null)
