...
open class GtsqueryConsistent1 : AbstractRoutine<Boolean>("gtsquery_consistent", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.gtsquery_consistent.RETURN_VALUE</code>.
         */
