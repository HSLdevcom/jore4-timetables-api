...
open class ColumnDomainUsage(
    ...
    override fun `as`(alias: Table<*>): ColumnDomainUsage = ColumnDomainUsage(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ColumnDomainUsage = ColumnDomainUsage(name.getQualifiedName(), null)
}
