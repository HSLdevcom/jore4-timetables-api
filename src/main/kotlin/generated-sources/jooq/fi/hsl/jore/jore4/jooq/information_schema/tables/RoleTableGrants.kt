...
open class RoleTableGrants(
    ...
    override fun `as`(alias: Table<*>): RoleTableGrants = RoleTableGrants(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): RoleTableGrants = RoleTableGrants(name.getQualifiedName(), null)
}
