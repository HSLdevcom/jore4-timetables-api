...
open class PgLsnHashExtended : AbstractRoutine<Long>("pg_lsn_hash_extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_lsn_hash_extended.RETURN_VALUE</code>.
         */
