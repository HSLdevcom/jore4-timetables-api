...
open class ForeignDataWrappers(
     ...
     */
    val LIBRARY_NAME: TableField<Record, String?> = createField(DSL.name("library_name"), SQLDataType.VARCHAR, this, "")

    /**
     * The column
     * <code>information_schema.foreign_data_wrappers.foreign_data_wrapper_language</code>.
     */
    val FOREIGN_DATA_WRAPPER_LANGUAGE: TableField<Record, String?> = createField(DSL.name("foreign_data_wrapper_language"), SQLDataType.VARCHAR, this, "")
    ...
    override fun `as`(alias: Table<*>): ForeignDataWrappers = ForeignDataWrappers(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ForeignDataWrappers = ForeignDataWrappers(name.getQualifiedName(), null)
}
