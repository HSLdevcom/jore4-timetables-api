...
open class GbtTimeConsistent : AbstractRoutine<Boolean>("gbt_time_consistent", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter <code>public.gbt_time_consistent.RETURN_VALUE</code>.
         */
     ...
     */
    fun set__2(value: LocalTime?): Unit = setValue(_2, value)
