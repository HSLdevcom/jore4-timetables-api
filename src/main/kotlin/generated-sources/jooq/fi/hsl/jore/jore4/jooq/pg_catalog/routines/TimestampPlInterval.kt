...
open class TimestampPlInterval : AbstractRoutine<LocalDateTime>("timestamp_pl_interval", PgCatalog.PG_CATALOG, SQLDataType.LOCALDATETIME(6)) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.timestamp_pl_interval.RETURN_VALUE</code>.
         */
