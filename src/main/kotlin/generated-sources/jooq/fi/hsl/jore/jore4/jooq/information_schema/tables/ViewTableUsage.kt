...
open class ViewTableUsage(
    ...
    override fun `as`(alias: Table<*>): ViewTableUsage = ViewTableUsage(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ViewTableUsage = ViewTableUsage(name.getQualifiedName(), null)
}
