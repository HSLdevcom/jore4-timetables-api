...
open class UserMappings(
    ...
    override fun `as`(alias: Table<*>): UserMappings = UserMappings(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): UserMappings = UserMappings(name.getQualifiedName(), null)
}
