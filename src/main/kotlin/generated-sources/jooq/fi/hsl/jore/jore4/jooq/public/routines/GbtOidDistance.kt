...
open class GbtOidDistance : AbstractRoutine<Double>("gbt_oid_distance", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter <code>public.gbt_oid_distance.RETURN_VALUE</code>.
         */
