...
open class Overlaps5 : AbstractRoutine<Boolean>("overlaps", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {
     ...
     */
    fun set__3(value: OffsetDateTime?): Unit = setValue(_3, value)
     ...
     */
    fun set__4(value: OffsetDateTime?): Unit = setValue(_4, value)
