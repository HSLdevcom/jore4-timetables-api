...
open class PgIndexamProgressPhasename : AbstractRoutine<String>("pg_indexam_progress_phasename", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    companion object {
        ...
        /**
         * The parameter
         * <code>pg_catalog.pg_indexam_progress_phasename._1</code>.
         */
        val _1: Parameter<Long?> = Internal.createParameter("_1", SQLDataType.BIGINT, false, true)

        /**
         * The parameter
         * <code>pg_catalog.pg_indexam_progress_phasename._2</code>.
         */
