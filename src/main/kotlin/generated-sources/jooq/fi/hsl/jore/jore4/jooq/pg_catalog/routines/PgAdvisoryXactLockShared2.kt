...
open class PgAdvisoryXactLockShared2 : AbstractRoutine<java.lang.Void>("pg_advisory_xact_lock_shared", PgCatalog.PG_CATALOG) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_advisory_xact_lock_shared._1</code>.
         */
        val _1: Parameter<Int?> = Internal.createParameter("_1", SQLDataType.INTEGER, false, true)

        /**
         * The parameter
         * <code>pg_catalog.pg_advisory_xact_lock_shared._2</code>.
         */
