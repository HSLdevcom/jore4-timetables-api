...
open class PgTypeIsVisible : AbstractRoutine<Boolean>("pg_type_is_visible", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_type_is_visible.RETURN_VALUE</code>.
         */
