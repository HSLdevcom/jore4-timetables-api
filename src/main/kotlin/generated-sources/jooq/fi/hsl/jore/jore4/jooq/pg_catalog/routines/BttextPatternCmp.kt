...
open class BttextPatternCmp : AbstractRoutine<Int>("bttext_pattern_cmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.bttext_pattern_cmp.RETURN_VALUE</code>.
         */
