...
open class TimestamptzLtDate : AbstractRoutine<Boolean>("timestamptz_lt_date", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.timestamptz_lt_date.RETURN_VALUE</code>.
         */
