...
open class TableConstraints(
    ...
    override fun `as`(alias: Table<*>): TableConstraints = TableConstraints(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): TableConstraints = TableConstraints(name.getQualifiedName(), null)
}
