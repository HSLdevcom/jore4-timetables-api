...
open class Float8StddevSamp : AbstractRoutine<Double>("float8_stddev_samp", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.float8_stddev_samp.RETURN_VALUE</code>.
         */
