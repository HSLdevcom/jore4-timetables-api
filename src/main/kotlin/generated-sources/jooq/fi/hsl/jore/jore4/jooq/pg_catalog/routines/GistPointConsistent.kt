...
open class GistPointConsistent : AbstractRoutine<Boolean>("gist_point_consistent", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.gist_point_consistent.RETURN_VALUE</code>.
         */
