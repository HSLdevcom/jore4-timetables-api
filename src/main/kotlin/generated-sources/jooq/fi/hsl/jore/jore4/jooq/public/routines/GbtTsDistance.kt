...
open class GbtTsDistance : AbstractRoutine<Double>("gbt_ts_distance", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter <code>public.gbt_ts_distance.RETURN_VALUE</code>.
         */
