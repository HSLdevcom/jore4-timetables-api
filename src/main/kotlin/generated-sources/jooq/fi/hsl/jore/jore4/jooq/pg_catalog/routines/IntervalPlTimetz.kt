...
open class IntervalPlTimetz : AbstractRoutine<OffsetTime>("interval_pl_timetz", PgCatalog.PG_CATALOG, SQLDataType.TIMEWITHTIMEZONE(6)) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.interval_pl_timetz.RETURN_VALUE</code>.
         */
