...
open class Icregexeqjoinsel : AbstractRoutine<Double>("icregexeqjoinsel", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    companion object {
     ...
     */
    fun set__4(value: Short?): Unit = setValue(_4, value)
