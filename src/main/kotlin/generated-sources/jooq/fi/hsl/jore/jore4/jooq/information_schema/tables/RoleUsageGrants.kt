...
open class RoleUsageGrants(
    ...
    override fun `as`(alias: Table<*>): RoleUsageGrants = RoleUsageGrants(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): RoleUsageGrants = RoleUsageGrants(name.getQualifiedName(), null)
}
