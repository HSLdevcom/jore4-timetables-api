...
open class GbtTstzConsistent : AbstractRoutine<Boolean>("gbt_tstz_consistent", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter <code>public.gbt_tstz_consistent.RETURN_VALUE</code>.
         */
