...
open class GbtNumericConsistent : AbstractRoutine<Boolean>("gbt_numeric_consistent", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>public.gbt_numeric_consistent.RETURN_VALUE</code>.
         */
        ...
        /**
         * The parameter <code>public.gbt_numeric_consistent._2</code>.
         */
        val _2: Parameter<BigDecimal?> = Internal.createParameter("_2", SQLDataType.NUMERIC, false, true)

        /**
         * The parameter <code>public.gbt_numeric_consistent._3</code>.
         */
        val _3: Parameter<Short?> = Internal.createParameter("_3", SQLDataType.SMALLINT, false, true)

        /**
         * The parameter <code>public.gbt_numeric_consistent._4</code>.
         */
