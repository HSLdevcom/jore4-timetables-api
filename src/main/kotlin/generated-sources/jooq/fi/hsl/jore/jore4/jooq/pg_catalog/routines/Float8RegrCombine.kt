...
open class Float8RegrCombine : AbstractRoutine<Array<Double?>>("float8_regr_combine", PgCatalog.PG_CATALOG, SQLDataType.FLOAT.getArrayDataType()) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.float8_regr_combine.RETURN_VALUE</code>.
         */
        val RETURN_VALUE: Parameter<Array<Double?>?> = Internal.createParameter("RETURN_VALUE", SQLDataType.FLOAT.getArrayDataType(), false, false)
