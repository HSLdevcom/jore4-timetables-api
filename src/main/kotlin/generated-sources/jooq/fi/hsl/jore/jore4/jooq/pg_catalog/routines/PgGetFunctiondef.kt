...
open class PgGetFunctiondef : AbstractRoutine<String>("pg_get_functiondef", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_get_functiondef.RETURN_VALUE</code>.
         */
