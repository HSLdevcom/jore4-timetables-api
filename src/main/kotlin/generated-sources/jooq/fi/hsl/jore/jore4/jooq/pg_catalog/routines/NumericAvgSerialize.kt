...
open class NumericAvgSerialize : AbstractRoutine<ByteArray>("numeric_avg_serialize", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.numeric_avg_serialize.RETURN_VALUE</code>.
         */
