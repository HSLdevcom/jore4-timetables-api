...
open class PgExportSnapshot : AbstractRoutine<String>("pg_export_snapshot", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_export_snapshot.RETURN_VALUE</code>.
         */
