...
open class _PgExpandarray(
    ...
    override fun `as`(alias: Table<*>): _PgExpandarray = _PgExpandarray(alias.getQualifiedName(), this, parameters)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): _PgExpandarray = _PgExpandarray(name.getQualifiedName(), null, parameters)
