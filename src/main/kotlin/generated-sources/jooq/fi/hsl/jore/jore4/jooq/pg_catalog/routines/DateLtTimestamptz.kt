...
open class DateLtTimestamptz : AbstractRoutine<Boolean>("date_lt_timestamptz", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.date_lt_timestamptz.RETURN_VALUE</code>.
         */
