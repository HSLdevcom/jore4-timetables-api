...
open class InetGistConsistent : AbstractRoutine<Boolean>("inet_gist_consistent", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.inet_gist_consistent.RETURN_VALUE</code>.
         */
