...
open class ColumnColumnUsage(
    ...
    override fun `as`(alias: Table<*>): ColumnColumnUsage = ColumnColumnUsage(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ColumnColumnUsage = ColumnColumnUsage(name.getQualifiedName(), null)
}
