...
open class GbtInt4Distance : AbstractRoutine<Double>("gbt_int4_distance", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter <code>public.gbt_int4_distance.RETURN_VALUE</code>.
         */
