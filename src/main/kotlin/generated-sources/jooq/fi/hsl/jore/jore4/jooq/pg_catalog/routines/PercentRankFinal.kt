...
open class PercentRankFinal : AbstractRoutine<Double>("percent_rank_final", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.percent_rank_final.RETURN_VALUE</code>.
         */
