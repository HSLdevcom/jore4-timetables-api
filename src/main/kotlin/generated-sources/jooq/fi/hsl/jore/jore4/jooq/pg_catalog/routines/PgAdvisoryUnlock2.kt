...
open class PgAdvisoryUnlock2 : AbstractRoutine<Boolean>("pg_advisory_unlock", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_advisory_unlock.RETURN_VALUE</code>.
         */
