...
open class GistPolyConsistent : AbstractRoutine<Boolean>("gist_poly_consistent", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.gist_poly_consistent.RETURN_VALUE</code>.
         */
