...
open class EnabledRoles(
    ...
    override fun `as`(alias: Table<*>): EnabledRoles = EnabledRoles(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): EnabledRoles = EnabledRoles(name.getQualifiedName(), null)
}
