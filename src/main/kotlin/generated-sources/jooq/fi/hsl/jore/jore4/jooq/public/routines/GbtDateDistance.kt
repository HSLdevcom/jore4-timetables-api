...
open class GbtDateDistance : AbstractRoutine<Double>("gbt_date_distance", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter <code>public.gbt_date_distance.RETURN_VALUE</code>.
         */
