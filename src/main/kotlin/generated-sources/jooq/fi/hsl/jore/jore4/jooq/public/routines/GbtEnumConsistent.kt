...
open class GbtEnumConsistent : AbstractRoutine<Boolean>("gbt_enum_consistent", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter <code>public.gbt_enum_consistent.RETURN_VALUE</code>.
         */
        ...
        /**
         * The parameter <code>public.gbt_enum_consistent._3</code>.
         */
        val _3: Parameter<Short?> = Internal.createParameter("_3", SQLDataType.SMALLINT, false, true)

        /**
         * The parameter <code>public.gbt_enum_consistent._4</code>.
         */
