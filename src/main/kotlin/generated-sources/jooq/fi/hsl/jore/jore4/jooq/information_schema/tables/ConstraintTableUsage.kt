...
open class ConstraintTableUsage(
    ...
    override fun `as`(alias: Table<*>): ConstraintTableUsage = ConstraintTableUsage(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ConstraintTableUsage = ConstraintTableUsage(name.getQualifiedName(), null)
}
