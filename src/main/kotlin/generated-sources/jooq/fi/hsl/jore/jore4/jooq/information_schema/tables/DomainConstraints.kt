...
open class DomainConstraints(
    ...
    override fun `as`(alias: Table<*>): DomainConstraints = DomainConstraints(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): DomainConstraints = DomainConstraints(name.getQualifiedName(), null)
}
