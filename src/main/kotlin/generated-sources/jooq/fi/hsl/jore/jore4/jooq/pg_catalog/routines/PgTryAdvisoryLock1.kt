...
open class PgTryAdvisoryLock1 : AbstractRoutine<Boolean>("pg_try_advisory_lock", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_try_advisory_lock.RETURN_VALUE</code>.
         */
