...
open class PgControlCheckpoint : AbstractRoutine<java.lang.Void>("pg_control_checkpoint", PgCatalog.PG_CATALOG) {
    companion object {
        ...
        val CHECKPOINT_LSN: Parameter<Any?> = Internal.createParameter("checkpoint_lsn", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_lsn\""), false, false)
        @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
        val REDO_LSN: Parameter<Any?> = Internal.createParameter("redo_lsn", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_lsn\""), false, false)
