...
open class GistPointDistance : AbstractRoutine<Double>("gist_point_distance", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.gist_point_distance.RETURN_VALUE</code>.
         */
