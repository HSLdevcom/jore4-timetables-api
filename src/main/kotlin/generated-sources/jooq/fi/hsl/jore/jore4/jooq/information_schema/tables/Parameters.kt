...
open class Parameters(
    ...
    override fun `as`(alias: Table<*>): Parameters = Parameters(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): Parameters = Parameters(name.getQualifiedName(), null)
}
