...
open class ColumnOptions(
    ...
    override fun `as`(alias: Table<*>): ColumnOptions = ColumnOptions(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ColumnOptions = ColumnOptions(name.getQualifiedName(), null)
}
