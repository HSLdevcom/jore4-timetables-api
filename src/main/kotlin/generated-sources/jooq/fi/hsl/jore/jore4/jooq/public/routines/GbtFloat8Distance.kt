...
open class GbtFloat8Distance : AbstractRoutine<Double>("gbt_float8_distance", fi.hsl.jore.jore4.jooq.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {

        /**
         * The parameter <code>public.gbt_float8_distance.RETURN_VALUE</code>.
         */
