...
open class PgStatGetBgwriterStatResetTime : AbstractRoutine<OffsetDateTime>("pg_stat_get_bgwriter_stat_reset_time", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    companion object {
