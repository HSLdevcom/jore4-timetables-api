...
open class Int8incFloat8Float8 : AbstractRoutine<Long>("int8inc_float8_float8", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.int8inc_float8_float8.RETURN_VALUE</code>.
         */
