...
open class TransactionTimestamp : AbstractRoutine<OffsetDateTime>("transaction_timestamp", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.transaction_timestamp.RETURN_VALUE</code>.
         */
