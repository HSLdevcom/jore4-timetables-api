...
open class GtsvectorConsistent2 : AbstractRoutine<Boolean>("gtsvector_consistent", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.gtsvector_consistent.RETURN_VALUE</code>.
         */
