...
open class ReferentialConstraints(
    ...
    override fun `as`(alias: Table<*>): ReferentialConstraints = ReferentialConstraints(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): ReferentialConstraints = ReferentialConstraints(name.getQualifiedName(), null)
}
