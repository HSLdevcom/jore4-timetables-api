...
open class PgClientEncoding : AbstractRoutine<String>("pg_client_encoding", PgCatalog.PG_CATALOG, SQLDataType.VARCHAR) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_client_encoding.RETURN_VALUE</code>.
         */
