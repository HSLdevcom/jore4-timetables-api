...
open class SqlSizing(
     ...
     */
    val SUPPORTED_VALUE: TableField<Record, Int?> = createField(DSL.name("supported_value"), SQLDataType.INTEGER, this, "")
    ...
    override fun `as`(alias: Table<*>): SqlSizing = SqlSizing(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): SqlSizing = SqlSizing(name.getQualifiedName(), null)
}
