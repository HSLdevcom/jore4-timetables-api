...
open class PgTableIsVisible : AbstractRoutine<Boolean>("pg_table_is_visible", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {

        /**
         * The parameter
         * <code>pg_catalog.pg_table_is_visible.RETURN_VALUE</code>.
         */
