...
open class InRange11 : AbstractRoutine<Boolean>("in_range", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    companion object {
     ...
     */
    fun set__3(value: YearToSecond?): Unit = setValue(_3, value)
     ...
     */
    fun set__5(value: Boolean?): Unit = setValue(_5, value)
